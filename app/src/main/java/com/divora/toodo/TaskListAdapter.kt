...
class TaskListAdapter(private val onTaskCheckedChanged: (Task, Boolean) -> Unit) :
    ...
    override fun onBindViewHolder(holder: TaskViewHolder, position: Int) {
        ...
        holder.bind(current, onTaskCheckedChanged)
    }
    ...
    class TaskViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(task: Task, onTaskCheckedChanged: (Task, Boolean) -> Unit) {
